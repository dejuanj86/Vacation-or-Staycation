...
<html>
<head>
  	<title>The Perfect Staycation! - Vacation or Staycation</title>
  	<meta charset="utf-8" />
...
<body id="app-body">
	...
	<div class="container col-lg-12" id="">
		<h1>Only $${adjustedPrice}/person!</h1>
		<div id="eachHotel">
		<table class="table table-success table-hover">
			...
			<tbody>
				...
				<tr><td><input class="btn btn-success" type="submit" name="resultSelection" value="Book My Hotel and Attraction"></td></tr>
